...
uploaded_file = st.sidebar.file_uploader('Step 2: Upload Data Template', type=['xlsx'], on_change=upload_num,args={'upload done'})

if (uploaded_file is not None) or (st.session_state.read_upload == True):
