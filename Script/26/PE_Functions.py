...
#     df.to_excel('check_final.xlsx')
    ...
    df_result_gender.loc[df_result_gender['PVALUE']<=0.05,"STAT_COUNT"] = 1
    ...
    df_result_eth['STAT_COUNT'] = "No"
    df_result_eth.loc[df_result_eth['PVALUE']<=0.05,"STAT"] = "Yes"
    df_result_eth.loc[df_result_eth['PVALUE']<=0.05,"STAT"] = 1
...
#         test1.plotly_chart(fig_gender_bar, use_container_width=True)
        ...
        # Show Gender Gap
        main_page.markdown("""---""")
        metric_net_gap_1, metric_net_gap_2, metric_net_gap_3 = main_page.columns((1, 2.5, 0.000001))            
        ...
        metric_net_gap_2.markdown("<h1 style='text-align: left; vertical-align: bottom;color: #3498DB; font-size: 150%; opacity: 0.7'>Observation</h1>", unsafe_allow_html=True)
