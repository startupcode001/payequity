    ...
    if (current_pvalue>=0.05) | (current_gap>0):
        ...
        for factor in factor_range:
            ...
            if resulting_pvalues>=seek_goal:
                ...
                # keep_list = ['EEID','S_Budget','S_Adjusted']
                # seek_budget_df = seek_budget_df[keep_list]
                scenario_ind_name = 'SCENARIO_B_IND_'+protect_group_class
                scenario_increase_name = 'SCENARIO_B_BUDGET_'+protect_group_class
                scenario_adjusted_name = 'SCENARIO_B_ADJUSTED_SALARY_'+protect_group_class
                scenario_adjusted_log_name = 'LOG_SCENARIO_B_ADJUSTED_SALARY_'+protect_group_class
    ...
    if submitted_form:
        ...
        while df_result['STAT_COUNT'].sum()>0:
            ...
            for protect_group_class, project_group_feature,init_current_gap,init_current_pvalue in df_result_loop:
                ...
                pv_result_name = 'pv_result'+protect_group_class
                pv_budget_name = 'pv_budget'+protect_group_class
